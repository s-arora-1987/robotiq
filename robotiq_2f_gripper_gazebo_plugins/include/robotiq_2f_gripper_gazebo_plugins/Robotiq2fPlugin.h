...
#ifndef GAZEBO_ROBOTIQ_2F_PLUGIN_HH
#define GAZEBO_ROBOTIQ_2F_PLUGIN_HH
...
///                   This parameter is optional.
class Robotiq2fPlugin : public gazebo::ModelPlugin
{
  ...
  /// \brief Constructor.
  public: Robotiq2fPlugin();

  /// \brief Destructor.
  public: virtual ~Robotiq2fPlugin();
  ...
  /// \brief Number of joints in the gripper.
  private: static const int NumJoints = 1;
  ...
  /// \brief Default topic name for sending control updates to the gripper.
  private: static const std::string DefaultTopicCommand;

  /// \brief Default topic name for receiving state updates from the gripper.
  ...
  private: robotiq_2f_gripper_control::Robotiq2FGripper_robot_output handleCommand;

  /// \brief HandleControl message. Last command received before changing the
  /// grasping mode.
  private: robotiq_2f_gripper_control::Robotiq2FGripper_robot_output lastHandleCommand;
  ...
  private: robotiq_2f_gripper_control::Robotiq2FGripper_robot_output prevCommand;

  /// \brief Original HandleControl message (published by user and unmodified).
  private: robotiq_2f_gripper_control::Robotiq2FGripper_robot_output userHandleCommand;
  ...
  private: robotiq_2f_gripper_control::Robotiq2FGripper_robot_input handleState;
  ...
  private: PubQueue<robotiq_2f_gripper_control::Robotiq2FGripper_robot_input>::Ptr pubHandleStateQueue;
  ...
  /// \brief PIDs used to control the finger velocities.
  private: gazebo::common::PID velPID[NumJoints];

};

#endif  // GAZEBO_ROBOTIQ_2F_PLUGIN_HH
